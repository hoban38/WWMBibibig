 ...
 * @author Yaniv Inbar
 */
class AsyncUpdateCalendarList extends CalendarListAsyncTask {

  private final String calendarId;
  private final Calendar entry;

  AsyncUpdateCalendarList(CalendarListActivity calendarSample, String calendarId, Calendar entry) {
