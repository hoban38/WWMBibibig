 ...
 * @author Yaniv Inbar
 */
class AsyncBatchInsertCalendarList extends CalendarListAsyncTask {

  private final List<Calendar> calendars;

  AsyncBatchInsertCalendarList(CalendarListActivity calendarSample, List<Calendar> calendars) {
